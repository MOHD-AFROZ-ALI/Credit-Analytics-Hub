...
def render_header():
    ...
    built_by_html = """
    <div style="border-top: 1px solid #333; margin-top: 0.75rem; padding-top: 0.5rem; display: flex; gap: 2rem; align-items: center; font-size: 1.1rem; color: #B0B0B0;">
        <span>Built by Mohd Afroz Ali</span>
        <a href="https://github.com/MOHD-AFROZ-ALI/Credit_Default_Predict" target="_blank" style="color:#00D4FF; text-decoration:none; display:flex; align-items:center; gap:0.5rem; font-weight: 600;">
        ...
        <a href="https://github.com/MOHD-AFROZ-ALI/Credit-Analytics-Hub" target="_blank" style="color:#00D4FF; text-decoration:none; display:flex; align-items:center; gap:0.5rem; font-weight: 600;">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M8 0C3.58 0 0 3.58 0 8a8 8 0 005.47 7.59c.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2 .37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.6 7.6 0 012-.27c.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.28.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8 8 0 0016 8c0-4.42-3.58-8-8-8z"/>
            </svg>
            GitHub v2
        </a>
        <a href="https://mohd-afroz-ali.github.io/projects/ML%203-Credit%20Default%20PRedict/report%20ml%203/finalshowcase.html" target="_blank" style="color:#00D4FF; text-decoration:none; display:flex; align-items:center; gap:0.5rem; font-weight: 600;">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M14 4.5V14a1 1 0 01-1 1H3a1 1 0 01-1-1V2a1 1 0 011-1h6.5L14 4.5zM9.5 1v3h3L9.5 1z"/>
            </svg>
            Report
        </a>
    </div>
